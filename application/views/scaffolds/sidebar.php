<div class="navbar-collapse collapse templatemo-sidebar" id = "div1">
  <ul class="templatemo-sidebar-menu" id = "navigation">
    ...
    <li><a href="<?php echo base_url();?>category/add_category"><i class="fa fa-folder-open"></i>&nbsp;MANAGE CATEGORY</a></li>
    ...
    <li class="sub ">
      <a href="javascript:;">
         <i class="fa fa-users"></i>MANAGE USER<div class="pull-right"><span class="caret"></span></div>
            ...
            <li><a href="<?php echo base_url();?>manageUser/account_list"><i class="fa fa-users"></i>&nbsp;&nbsp;  User List</a></li>
            </ul>  
      </li>
    <hr class = "sidebar-hr">
